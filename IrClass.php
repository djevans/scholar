...
class IrClass {
  ...
  /**
   * @todo Determine whats going on here.
   * 
   ...
   * @todo Determine whats going on here
   * 
   * Used in the add datastream form submit callback.
   * 
   * @global object $user
   * 
   ...
   */
  function addStreamFormSubmit($form_id, array $form_values) {
    module_load_include('inc', 'Fedora_Repository', 'api/fedora_utils');
    module_load_include('inc', 'Fedora_Repository', 'ObjectHelper');
   ...
   * @param array $form_values 
   */
  function updateRefworksMetaData(array $form_values) {
   ...
   *   XML String. 
   */
  function createRefworksFromForm(array $form_values) {
    module_load_include('inc', 'Fedora_Repository', 'api/fedora_utils');
